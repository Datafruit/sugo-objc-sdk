...
#if TARGET_OS_TV
#define SUGO_TVOS_EXTENSION 1
#endif

#if TARGET_OS_WATCH
#define SUGO_WATCH_EXTENSION 1
#endif

#define SUGO_NO_EXCEPTION_HANDLING (defined(SUGO_APP_EXTENSION))
#define SUGO_FLUSH_IMMEDIATELY (defined(SUGO_APP_EXTENSION) || defined(SUGO_WATCH_EXTENSION))
#define SUGO_NO_REACHABILITY_SUPPORT (defined(SUGO_APP_EXTENSION) || defined(SUGO_TVOS_EXTENSION) || defined(SUGO_WATCH_EXTENSION))
...
/*!
 ...
 @abstract
 Track a push notification using its payload sent from Sugo.
 
 @discussion
 To simplify user interaction tracking and a/b testing, Sugo
