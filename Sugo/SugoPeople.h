...
/*!
 ...
 @abstract
 controls the $ignore_time property in any subsequent SugoPeople operation.

 If the $ignore_time property is present and true in your request,
 Sugo will not automatically update the "Last Seen" property of the profile.
 Otherwise, Sugo will add a "Last Seen" property associated with the
...
/*!
 ...
 @discussion
 This will associate the device token with the current user in Sugo People,
 which will allow you to send push notifications to the user from the Sugo
...
/*!
 ...
 @abstract
 Set properties on the current user in Sugo People.
 ...
 <pre>
 // applies to both Sugo Engagement track: AND Sugo People set: and
 // increment: calls
 [sugo identify:distinctId];
 </pre>
...
/*!
 ...
 @abstract
 Convenience method for setting a single property in Sugo People.
...
/*!
 ...
 @abstract
 Set properties on the current user in Sugo People, but don't overwrite if
...
/*!
 ...
 @abstract
 Delete current user's record from Sugo People.
 */
- (void)deleteUser;
