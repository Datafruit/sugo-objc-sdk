...
- (void)setSugoViewId:(id)object
{
    objc_setAssociatedObject(self, @selector(sugoViewId), [object copy], OBJC_ASSOCIATION_RETAIN_NONATOMIC);
}

- (NSString *)mp_viewId
{
    return objc_getAssociatedObject(self, @selector(sugoViewId));
}
